...
public class MealTestData {
    ...
    public static final String START_DATE = "2015-05-30T01:00";
    public static final String END_DATE = "2015-05-30T23:00";
    ...
    public static void assertMatchMealTo(MealTo actual, MealTo expected) {
        assertThat(actual).isEqualToIgnoringGivenFields(expected, "excess");
    }
