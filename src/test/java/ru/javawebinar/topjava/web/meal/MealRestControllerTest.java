...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void testGetAll() throws Exception {
        mockMvc.perform(get(REST_URL))
                ...
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(contentJsonMealTo(getWithExcess(MEALS, DEFAULT_CALORIES_PER_DAY)));
    }
    ...
    void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?start=" + START_DATE + "&end=" + END_DATE))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(contentJsonMealTo(getWithExcess(List.of(MEAL3, MEAL2, MEAL1), DEFAULT_CALORIES_PER_DAY)));
    }
}